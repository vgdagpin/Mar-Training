...
namespace ClassLibrary1.Infrastructure.Migrations
{
    ...
    partial class ClassLibDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ClassLibrary1.Domain.Entities.LoginHistory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = -1,
                            LoginDate = new DateTime(2020, 4, 3, 22, 4, 21, 885, DateTimeKind.Local).AddTicks(318),
                            UserID = -1
                        },
                        new
                        {
                            ID = -2,
                            LoginDate = new DateTime(2020, 4, 3, 22, 4, 21, 887, DateTimeKind.Local).AddTicks(3961),
                            UserID = -1
                        });
                });
